...
\item 
Q\+Http\+Server\+Response \mbox{\hyperlink{classEmacsServer_a9258d2af4f1ebb68d78fb605dd755d7a}{download\+File\+Or\+Directory}} (const Q\+String \&base, const Q\+String \&name)
\item 
...
\item 
Q\+Http\+Server\+Response \mbox{\hyperlink{classEmacsServer_afedf1d40e26b5263e382b95cf68792d7}{parse\+File\+Or\+Directory}} (const Q\+String \&base, const Q\+String \&name)
\item 
...
\end{DoxyReturn}
\mbox{\Hypertarget{classEmacsServer_a9258d2af4f1ebb68d78fb605dd755d7a}\label{classEmacsServer_a9258d2af4f1ebb68d78fb605dd755d7a}} 
\index{EmacsServer@{EmacsServer}!downloadFileOrDirectory@{downloadFileOrDirectory}}
\index{downloadFileOrDirectory@{downloadFileOrDirectory}!EmacsServer@{EmacsServer}}
\doxysubsubsection{\texorpdfstring{downloadFileOrDirectory()}{downloadFileOrDirectory()}}
{\footnotesize\ttfamily Q\+Http\+Server\+Response Emacs\+Server\+::download\+File\+Or\+Directory (\begin{DoxyParamCaption}\item[{const Q\+String \&}]{base,  }\item[{const Q\+String \&}]{name }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [private]}}

Check if the given base and name combination is a valid file or directory (from filesystem or resource) and then either download or list it, depending on what was found.

\begin{DoxyReturn}{Returns}
Q\+Http\+Server\+Responder\+::\+Status\+Code\+::\+Bad\+Request on error or the file content/directory listing on success. Both the error and success messages are designed to be exposed to the Emacs UI and are translatable. 
\end{DoxyReturn}
...
\end{DoxyReturn}
\mbox{\Hypertarget{classEmacsServer_afedf1d40e26b5263e382b95cf68792d7}\label{classEmacsServer_afedf1d40e26b5263e382b95cf68792d7}} 
\index{EmacsServer@{EmacsServer}!parseFileOrDirectory@{parseFileOrDirectory}}
\index{parseFileOrDirectory@{parseFileOrDirectory}!EmacsServer@{EmacsServer}}
\doxysubsubsection{\texorpdfstring{parseFileOrDirectory()}{parseFileOrDirectory()}}
{\footnotesize\ttfamily Q\+Http\+Server\+Response Emacs\+Server\+::parse\+File\+Or\+Directory (\begin{DoxyParamCaption}\item[{const Q\+String \&}]{base,  }\item[{const Q\+String \&}]{name }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [private]}}

Check if the given base and name combination is a valid file or directory (from filesystem or resource) and then either template or list it, depending on what was found.

\begin{DoxyReturn}{Returns}
Q\+Http\+Server\+Responder\+::\+Status\+Code\+::\+Bad\+Request on error or the templated file/directory listing on success. Both the error and success messages are designed to be exposed to the Emacs UI and are translatable. 
\end{DoxyReturn}
